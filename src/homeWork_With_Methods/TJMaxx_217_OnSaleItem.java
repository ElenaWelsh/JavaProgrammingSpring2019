...
public class TJMaxx_217_OnSaleItem  extends TJMax_217_item {
	     ...
	     * - assigns discount
	     */
	    public TJMaxx_217_OnSaleItem(String name,int quantity,int catalogNumber,double price, double discount) {
