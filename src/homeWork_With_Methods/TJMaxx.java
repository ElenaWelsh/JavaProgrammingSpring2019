...
public class TJMaxx  {
     ...
     */
	 private List<TJMax_217_item> regularItems;
     private List<TJMaxx_217_OnSaleItem> onSaleItems;
     ...
     * @param item
     */
    public  void addRegularItem(TJMax_217_item item) {
     ...
     * @param item
     */
    public void addOnSaleItem(TJMaxx_217_OnSaleItem item) {
     ...
     * @return
     */
    public List<TJMax_217_item> getRegularItems() {
     ...
     * @return
     */
    public List<TJMaxx_217_OnSaleItem> getOnSaleItems() {
         //TODO change from null 
        return onSaleItems;
    }
    ...
    public List<String> getAllItemNames() {
     ...
     for(int i =0; i<onSaleItems.size();i++) {
    	 allItems.add(onSaleItems.get(i).getName());
     }
    ...
    for (int i =0; i<onSaleItems.size();i++) {
    	if (onSaleItems.get(i).getCatalogNumber()==catalogNumber) {
    		price=onSaleItems.get(i).getPrice();
    	}
    }
        return price;
    }
     ...
     * @return
     */
    public TJMaxx_217_OnSaleItem getOnSaleItem(String name)
    {
        for(int i=0;i<onSaleItems.size();i++) {
